      ...
      <div className="max-w-[1240px] mx-auto p-2 w-full py-8">
        <div className="col-span-4">
          ...
          <p className="text-center sm:text-lg">
            ...
            Tailwind css was used for styling and Framer Motion was used for animations.
            Overall it is simplistic and modern.
          </p>
          <div className="mt-10 flex justify-center">
            <button className="text-black bg-gradient-to-r from-[#FFDD00] to-[#FBB034] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
