      ...
      <div className="max-w-[1240px] mx-auto p-2 w-full py-8">
        <div className="col-span-4 text-center">
          ...
          <div className="mt-10 flex justify-center">
            <button className="text-black font-bold bg-gradient-to-r from-[#40e0d0] via-[#55dada] to-[#1d3463] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-10 sm:max-w-md sm:grid-cols-3 sm:gap-x-0 lg:mx-auto lg:max-w-lg  cursor-pointer">
