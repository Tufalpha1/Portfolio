...
export const Hero = () => {
  ...
  return (
    <section id="home" className="w-full h-screen text-center">
      ...
      <div className="hidden xl:block relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
        <div className="absolute left-1/2 top-4 h-[1026px] w-[1026px] -translate-x-1/3 stroke-gray-300/70 [mask-image:linear-gradient(to_bottom,white_20%,transparent_75%)] sm:top-16 sm:-translate-x-1/2 lg:-top-16 lg:ml-12 xl:-top-1 xl:ml-0">
          <svg
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#1190CB" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
          <svg
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#43cea2" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
